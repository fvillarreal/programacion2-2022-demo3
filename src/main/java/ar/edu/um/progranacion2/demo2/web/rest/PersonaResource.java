...
/**
 * REST controller for managing {@link ar.edu.um.progranacion2.demo2.domain.Persona}.
 */
@RestController
@RequestMapping("/api")
public class PersonaResource {
     ...
     */
    @GetMapping("/personas")
    public ResponseEntity<List<Persona>> getAllPersonas(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
