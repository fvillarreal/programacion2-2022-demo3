...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './persona.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONA actions', async () => {
      const expectedActions = [
        {
