...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JEMPLEADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_JEMPLEADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JEMPLEADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JEMPLEADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JEMPLEADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JEMPLEADO actions', async () => {
      const expectedActions = [
        {
