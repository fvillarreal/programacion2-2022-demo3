...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './j-venta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JVENTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_JVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JVENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JVENTA actions', async () => {
      const expectedActions = [
        {
